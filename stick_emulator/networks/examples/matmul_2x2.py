...
from stick_emulator.simulator import Simulator, decode_output, count_spikes
from stick_emulator.primitives import DataEncoder

from stick_emulator.compilation import report_neuron_usage, report_spike_estimation
...
if __name__ == "__main__":
    ...
    draw_comp_graph(out, outfile='matmul_2x2')
